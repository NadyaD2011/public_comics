...
def get_comics(random_number_comic):
...
def save_comics(comics_url, folder_name, random_number_comic):
...
def publish_photos(bot, chat_id, folder_name, text_post, random_number_comic):
...
def main():
    ...
    try:
        ...
        comics_url, text_post = get_comics(random_number_comic)
        save_comics(comics_url, folder_name, random_number_comic)
        publish_photos(bot, chat_id, folder_name, text_post, random_number_comic)
    finally:
